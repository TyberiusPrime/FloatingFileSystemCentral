...
class Config(DefaultConfig):
    ...
    def decide_targets(self, ffs):
        ...
        choices = [['martha', 'rose'], ['rose', 'martha'], ['amy', 'martha'],
                   ['amy', 'rose'], ['martha', 'amy'], ['rose', 'amy']]
        import random
    ...
    def decide_snapshots_to_keep(self, dummy_ffs_name, snapshots):
        ...
        keep = set([
            ...
            if not x.startswith('ffs-') and not x.startswith('zfs-auto-snap_')
            or x.endswith("-keep")
